...
import '../data/common_medications.dart';
...
class _AddMedicationScreenState extends State<AddMedicationScreen> {
  ...
  void _pickCommon(CommonMedication m) {
    setState(() {
      _name.text = m.name;
      _dosage.text = m.defaultDosage;
    });
  }
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            Text('اختيار سريع', style: theme.textTheme.titleSmall),
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  final m = commonMedications[i];
                  return ActionChip(
                    label: Text(m.name),
                    onPressed: () => _pickCommon(m),
                  );
                },
              ),
            ),
